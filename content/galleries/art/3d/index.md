...
author: "Suzuka Ka"
menus: "main"
categories: ["art", "wow", "cosas 3d" , "tresd", "mierdaaa"]
# categories: ["nature"]
# weight: 3
...
# params.sort_order – sort order. Default is asc.
  theme: light # – color theme for this page. Defaults to defaultTheme from configuration.
  # theme: "dark" # – color theme for this page. Defaults to defaultTheme from configuration.
---

# Contenido de prueba del 3D

A ver qué tal escribe esta mierda...

Centrado... me cago en su puta madre
