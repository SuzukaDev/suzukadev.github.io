...
# featured_image: images/the-resilence-of-memory.png # Name of the image file used for the album thumbnail. If NOT set, the first image which contains "feature" in its filename is used, otherwise the first image in the album.
...
<!-- {{< video v="dex-x5-v2-day-cycle.mp4" class="pixel-art no-box-shadow" c=false css="height: 75vh" autoplay=true loop=true >}} -->
