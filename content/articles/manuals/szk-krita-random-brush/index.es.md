...
description = "*Plugin* para Krita para elegir un pincel al azar."
...
> *Plugin* de Krita que añade una acción para seleccionar un pincel aleatorio.
...
<!-- Personalmente, encuentro esto muy útil y lo uso todo el tiempo cuando estoy haciendo miniaturas. Me gusta lanzar los dados un par de veces hasta que obtengo 1 o 2 pinceles aleatorios que me inspiran/generan contraste entre ellos. **** **** -->
Personalmente lo uso bastante a la hora de **hacer miniaturas/*thumbnails***. Viene bien para (re)descubrir pinceles y obtener resultados/texturas diferentes. Me gusta darle un par de veces hasta encontrar un par de pinceles que contrasten entre sí y que me inspiren, y con ellos hago una miniatura distinta:
...
<!-- {{<get_social github true "https://github.com/SuzukaDev/szk-krita-random-brush/" "Respositorio en Github" >}} -->