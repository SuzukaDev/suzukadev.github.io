...
show_right_bar = true
custom_pfp = "dex-cumple-15.png" # if set the article will use a custom image (NOT: You can also add the word 'pfp' to an image to automatically use it as the article's profile picture (pfp))
