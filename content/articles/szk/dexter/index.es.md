...
# # -------- DISPLAY OPTIONS --------
accent_color = "rgb(71, 69, 78)" # customize the color for links, etc in the page
...
custom_profile_description = "Mejor amigo de Dexter" # Adds a custom profile description (below the pfp) for the page.
