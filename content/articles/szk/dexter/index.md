...
description = "Little tribute to my best friend"
...
{{< box_warning >}}
Page not translated (at the moment). For reading the article, [visit the spanish version]({{% relref path="dexter" lang="es" %}}).
{{< /box_warning >}}
